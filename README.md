...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/plasticparcels-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/plasticparcels-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add plasticparcels
# for installing globally
pixi global install plasticparcels
```
...
It is possible to list all of the versions of `plasticparcels` available on your platform:
...
```
pixi search plasticparcels --channel conda-forge
```
